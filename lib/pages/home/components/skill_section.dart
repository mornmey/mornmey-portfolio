...
import 'package:mornmey_portfolio/models/skill.dart';
...
List<Skill> skills = [
  Skill(
    skill: "Dart",
    percentage: 90,
    langLink: "https://dart.dev/",
  ),
  Skill(
    skill: "Java",
    percentage: 40,
    langLink: "https://www.java.com/en/",
  ),
  Skill(
    skill: "PHP",
    percentage: 50,
    langLink: "https://www.php.net/",
  ),
  Skill(
    skill: "Python",
    percentage: 70,
    langLink: "https://www.python.org/",
  ),
  Skill(skill: "Other", percentage: 40, langLink: ""),
];
                                      ...
                                      child: InkWell(
                                        onTap: () async {
                                          if (skill.langLink == "") {
                                            ...
                                            await launchUrl(Uri.parse(skill.langLink));
                                          }
                                        },
                                        child: Container(
